...
const MERMAID_PATH = process.env.MERMAID_PATH || resolve('..', 'node_modules', 'mermaid');
const CMD_PATH = join(MERMAID_PATH, 'bin', 'mermaid.js');
const DEFAULT_STYLE = resolve('..', 'src', 'default-style.css');
const IMG_PATH = resolve('..', 'testrun');
const TEMP_PATH = '/tmp';
